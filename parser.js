...
module.exports.parse = async function(raw, {axios, yaml, notify,console},{ name, url, interval, selected }) {
  ...
  async function getConfig(axios,console,notify){
    ...
    await axios.get("https://cdn.jsdelivr.net/gh/fangweilong/clash-parsers/clash-for-windows/areas.json").then(function (response){
      areas=response.data;
    ...
    await axios.get("https://raw.githubusercontent.com/fangweilong/clash-parsers/main/clash-for-windows/rule_providers.yml").then(function (response){
    ...
    await axios.get("https://raw.githubusercontent.com/fangweilong/clash-parsers/main/clash-for-windows/rules.json").then(function (response){
      rules=response.data;
    }).catch(function(error){
      notify("错误",error)
